        ...
        <div className='flex items-center gap-3'>
          ...
          <div className='relative shrink-0'>
            <div className='relative h-10 w-10 rounded-full overflow-hidden'>
              ...
              <div
                className={`${avatarColor} text-sm font-bold transition-transform group-hover:scale-105 h-full w-full flex items-center justify-center text-white ${profilePicUrl ? 'hidden' : 'flex'
                  }`}
              >
